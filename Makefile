...
# Header files
_UI_DEPS = UIText.h UIComponent.h UIContainer.h UIContent.h UIDimension.h UIObject.h UIImage.h UIInheritable.h UIChildrenBox.h UIBackground.h UIEvent.h

# Generate header filepaths
UI_DEPS = $(patsubst %,$(UI_INCLUDE_DIRECTORY)\\%,$(_UI_DEPS))

# Object files
_UI_OBJS = UIText.o UIComponent.o UIContainer.o UIContent.o UIDimension.o UIObject.o UIImage.o UIChildrenBox.o UIBackground.o UIEvent.o
